...
curl -H "Authorization: $LD_QLIK_READ_TOKEN" https://app.launchdarkly.com/api/v2/flags/talend-cloud-qlik > qlik_talend-cloud_flags.json
...
sed 's/talend-cloud-qlik/talend-cloud/g' qlik_talend-cloud_flags_formatted.json > qlik_talend-cloud_flags_updated.json
