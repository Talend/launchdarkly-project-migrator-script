...
echo "importing stitch project and environments..."
deno run --allow-env --allow-read --allow-net --allow-write migrate-projects.ts -p stitch -k $LD_QLIK_WRITE_TOKEN -d stitch 2>&1 | tee import_stitch_project.log
